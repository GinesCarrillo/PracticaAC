...
```{r}
  subset_credit$Prediccion_simple <- ifelse(subset_credit$Esfuerzo_financiero > 1.6, "+", "-")
  ...
  conf_df <- conf_df %>%
    mutate(Tipo = case_when(
      Real == "+" & Predicho == "+" ~ "Verdadero Positivo",
      Real == "-" & Predicho == "+" ~ "Falso Positivo",
      Real == "-" & Predicho == "-" ~ "Verdadero Negativo",
      Real == "+" & Predicho == "-" ~ "Falso Negativo"
    ))
