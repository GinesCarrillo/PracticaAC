...
Obsevando los resultados obtenidos podemos comprobar que el efecto
...
dataset no contiene patrones que se puedan explotar para mejorar la
clasificacion, más allá de alguna tenue mejora sobre los patrones superficiales
ya encontrados por nosotros.

Los mejores resultados se obtienen con un valor de `size` 11 o 15, con un `decay`
