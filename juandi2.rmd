...
vars_to_transform <- names(credit)[campos_numericos]
...
La PVE de un componente coincide con la proporción del autovalor m-ésimo... (TODO)
...
credit_no_na_esfuerzo <- na.omit(credit.Datos.Train)
...
credit.ranger <- train(
  credit_no_na_esfuerzo[credit.Vars.Entrada.Usadas],  
...
Al dar como resultado una profundidad de 7, sabemos que el árbol final de decisión utiliza 
siete comprobaciones para la clasificación. Podemos ver la evolución de la acurracy en función de la tasa de aprendizaje
